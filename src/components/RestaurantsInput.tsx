import type { Restaurant } from '../types/patch'

type Props = {
  value: Restaurant[]
  onChange: (value: Restaurant[]) => void
}
...
export default function RestaurantsInput({ value, onChange }: Props) {
  function updateAt(index: number, patch: Partial<Restaurant>) {
